...
typedef CollisionboxMovementController CollisionboxMovementController;
...
CollisionResponse handleCollisionHorizontal(std::shared_ptr<Tile>& tile, CollisionboxMovementController& object);
CollisionResponse handleCollisionVertical(std::shared_ptr<Tile>& tile, CollisionboxMovementController& object);

bool handleSolidTileCollisionHorizontal(std::shared_ptr<Tile>& tile, CollisionboxMovementController& object);
bool handleUpSlopeTileCollision(std::shared_ptr<Tile>& tile, CollisionboxMovementController& object);

bool handleSolidTileCollisionVertical(std::shared_ptr<Tile>& tile, CollisionboxMovementController& object);
