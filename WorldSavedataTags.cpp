...
const DataTagPair worldBoundsDefaultTag("worldBoundsDefaultBegin", "worldBoundsDefaultEnd");
...
const DataTagPair playerControlsTag("PlayerControlsBegin", "PlayerControlsEnd");
